    ...
    <el-row :gutter="20">
      <el-col :span="24" class="toolbar">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item>
            <el-button type="primary" icon="el-icon-search" v-on:click="getRoleList">查询</el-button>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" icon="el-icon-close" v-on:click="resetForm">重置</el-button>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" class="toolbar" style="padding-top: 0px">
        <div class="grid-content bg-purple">
          ...
          <el-table :data="roleList" highlight-current-row v-loading="listLoading" fit style="width: 100%;">
            ...
            <el-table-column prop="opTime" label="更新时间" sortable>
            </el-table-column>
            <el-table-column label="操作" width="180">
              <template slot-scope="scope">
                <el-button type="warning"  icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)">编辑
                </el-button>
                <el-button type="danger"  icon="el-icon-delete" @click="handleDel(scope.$index, scope.row)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  ...
  import { getRoleList, editRole, getRoleInfo, deleteRole } from '@/api/system/role'
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit: function (index, row) {
        ...
        getRoleInfo(row.id).then(response => {
          this.editForm = response;
          this.$refs.tree.setCheckedNodes(response.menus);
        })
      },
